...
| 3.4 | Runbook drills: worker replace, Redis restart, restore from backup (T-20) | 3.3 | 13-runbook | done this PR |
| 3.5 | Minimal console (Next.js, own container per ADR-012): login via key, usage chart, key management | 2.6,2.7 | F-12 | done this PR |
| 3.6 | Python + JS SDK thin clients over generated types; docs at `/docs` in the console | 1.14 | F-14 | done this PR |
